...
namespace org.dmxc.wkdt.Network
{
    public readonly struct MACAddress : IEquatable<MACAddress>
    {
        ...
        private static readonly Regex regex6g = new Regex(@"^([A-Fa-f0-9]{1,2})[\:\-\s]([A-Fa-f0-9]{1,2})[\:\-\s]([A-Fa-f0-9]{1,2})[\:\-\s]([A-Fa-f0-9]{1,2})[\:\-\s]([A-Fa-f0-9]{1,2})[\:\-\s]([A-Fa-f0-9]{1,2})$");
        ...
        public MACAddress(in IEnumerable<byte> enumerable)
        {
